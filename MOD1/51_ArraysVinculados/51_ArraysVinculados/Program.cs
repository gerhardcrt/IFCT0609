...
namespace _51_ArraysVinculados
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] nombresAlumnos = new string[] { "Chus", "Carlos", "Bardia", "Francis" };
            ...
            for (int fila = 0; fila <= notasAlumnos.GetUpperBound(0); fila++)
            {
                ...
                Console.WriteLine($"La media {nombresAlumnos[fila]} es: {media}");
            ...
            media = total / (float)(notasAlumnos.GetUpperBound(1) + 1);
            Console.WriteLine($"La media de {nombresAlumnos[numeroAlumno-1]} es: {media}");
