...
namespace EG22_ADO_Access_LoginUsuarioV2.loginDataSetTableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `usuarios` WHERE ((`usuario` = ?) AND ((? = 1 AND `password` IS NULL)" +
                " OR (`password` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `usuarios` (`usuario`, `password`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `usuarios` SET `usuario` = ?, `password` = ? WHERE ((`usuario` = ?) AND ((" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EG22_ADO_Access_LoginUsuarioV2.Properties.Settings.Default.loginConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT usuario, [password] FROM usuarios";
        ...
        public virtual int Fill(loginDataSet.usuariosDataTable dataTable) {
        ...
        public virtual loginDataSet.usuariosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            loginDataSet.usuariosDataTable dataTable = new loginDataSet.usuariosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(loginDataSet.usuariosDataTable dataTable) {
