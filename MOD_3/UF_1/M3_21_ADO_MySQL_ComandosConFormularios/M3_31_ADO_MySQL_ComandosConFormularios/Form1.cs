    ...
    public partial class Form1 : Form
    {
        ...
        private void btnInserir_Click(object sender, EventArgs e)
        {
            ...
            if (txtLogin.Text!="" && txtNombre.Text!="" && txtPass.Text != "")
            {
                ...
                string cadenaComando = $"INSERT INTO `alumnos` (`id`, `nombre`, `axuda`, `login`, `pass`) VALUES (NULL, '{txtNombre.Text}', '{nudAxuda.Value.ToString().Replace(',', '.')}', '{txtLogin.Text}', '{txtPass.Text}')";
