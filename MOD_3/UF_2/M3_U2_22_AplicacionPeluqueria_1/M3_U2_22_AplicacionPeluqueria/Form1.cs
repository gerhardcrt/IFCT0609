...
namespace M3_U2_22_AplicacionPeluqueria
{
    public partial class frmGestionPeluqueria : Form
    {
        ...
        private void CargarClientes() 
        {
            ...
            {
                return; //Si no soy capaz de rellenar el DS, salgo del procedmiento 
            }
        ...
        private void lbTicketsPRoductos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (lbTicketsPRoductos.SelectedIndex != -1)
            {
                ...
                foreach(DetalleTicketProducto detalle in t.ProductosComprados)//recorro la lista
                {
                    lbDetalleTicketsProductos.Items.Add(detalle);//obtengo el detalle del ticket
                }
            }
        }
    }
